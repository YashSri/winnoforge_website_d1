  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center text-center">
        <h2 className="footer-title mb-10 text-[15vw] leading-[0.85] font-black tracking-tight text-black md:text-[12vw]">
          READY TO
          <br />
          FORGE?
        </h2>
        ...
        <button
          onClick={() => open("join")}
          className="footer-cta group mx-auto flex items-center gap-4 rounded-full bg-black px-12 py-6 text-2xl font-bold text-white shadow-2xl transition-all hover:scale-105 hover:bg-[#395886] active:scale-95 md:text-3xl"
        >
          Join the Revolution
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-end justify-between gap-6 pt-8 pb-8 md:flex-row">
        ...
        <div className="flex gap-6 font-medium text-black">
          <a
            href="https://www.instagram.com/forgeinitiatives?igsh=dGV1NDJ5cm9jYWdr"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/showcase/forge-begin/"
            target="_blank"
            rel="noopener noreferrer"
            className="transition-colors hover:text-black/70 hover:underline"
          >
      ...
      <div className="relative z-10 border-t border-white/20 pt-6 text-center text-sm text-black">
        <p>
          &copy; {new Date().getFullYear()} FORGE Ecosystem. All rights
          reserved.
        </p>
      </div>
    </footer>
