export default function FeaturedVoicesEditorial() {
  return (
    <section className="mx-auto w-full max-w-3xl px-6 py-16 text-center md:px-12 md:py-24">
      ...
      <h2 className="mt-3 font-clash text-3xl font-semibold text-foreground md:text-4xl">
        What People Are Learning, Building, and Sharing
      </h2>
      <p className="mx-auto mt-6 max-w-xl font-jakarta text-base leading-relaxed text-foreground/70">
        Learners, mentors, speakers, faculty, founders, and industry contributors across FORGE
        have real reflections worth sharing. We publish quotes only once they're confirmed and
        approved by the person who gave them — check back here as verified voices are added.
      </p>
    </section>
  );
}
