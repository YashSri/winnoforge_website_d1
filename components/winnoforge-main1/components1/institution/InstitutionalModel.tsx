...
export function InstitutionalModel() {
  const models: ModelBlock[] = [
    {
      title: "Continuous Activation",
      description: "Seminars, workshops, and hackathons create consistent exposure and engagement.",
      icon: Activity,
    },
    {
      title: "Structured Execution",
      description: "Bootcamps and Citadel cycles ensure ideas move into real builds and prototypes.",
      icon: Layers3,
    },
    {
      title: "Measurable Outcomes",
      description: "Performance tracking, mentor reviews, and startup outputs replace activity-based engagement.",
      icon: BarChart3,
    },
  ];
    ...
    <section className="px-4 py-10 md:px-8 md:py-16">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-center font-jakarta text-base leading-relaxed text-foreground/70 md:text-lg">
          A structured, year-long innovation framework integrated within campus operations.
        </p>
