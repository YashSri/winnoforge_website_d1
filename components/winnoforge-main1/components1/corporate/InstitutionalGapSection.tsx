        ...
        <div className="grid md:grid-cols-[1.1fr_0.9fr]">
          <div className="p-7 md:p-10 lg:p-12">
            ...
            <div className="mt-6 space-y-4 font-jakarta text-base leading-relaxed text-[#d8e7f5] md:text-lg">
              <p>
                Modern campuses have infrastructure, labs, AI centres, and
                resources, but lack structured execution.
              </p>
              <p>
                Students attend workshops and hackathons, yet very few graduate
                having built real products, startups, or validated solutions.
              </p>
