...
const engineSteps: EngineStep[] = [
  {
    title: "Ignite",
    description: "Explore technologies and ideas.",
  },
  {
    title: "Innovate",
    description: "Turn ideas into concepts.",
  },
  {
    title: "Forge",
    description: "Build prototypes and MVPs.",
  },
  {
    title: "Launch",
    description: "Present and scale startups.",
  },
];

export default function ForgeEngineSection() {
  return (
