        ...
        <div className="certificate-card fade-in-up">
          ...
          <div className="cert-content">
            <div className="cert-logo">
              ...
              >
                <title>Certificate shield icon</title>
            ...
            <div className="verified-badge">
              <svg
                ...
                strokeWidth="2.5"
              >
                <title>Verified status icon</title>
      ...
      <div className="invalid-card fade-in-up">
        <div className="invalid-icon">
          <svg
            ...
            strokeWidth="1.5"
          >
            <title>Invalid certificate icon</title>
        ...
        <p className="invalid-hint">
          The certificate may have been revoked or the verification link is
          incorrect.
        </p>
        ...
        <div className="invalid-timestamp">
          <svg
            ...
            strokeWidth="2"
          >
            <title>Verification timestamp icon</title>
            <circle cx="12" cy="12" r="10" />
