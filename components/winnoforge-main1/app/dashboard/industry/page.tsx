        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your projects and discover talent.
            </p>
          </div>
          <button
            type="button"
            className="bg-primary text-white px-6 py-2.5 rounded-full font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {[1, 2, 3].map((i) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Posted on Oct {10 + i}, 2025 • Due Nov 30
                      </p>
                    </div>
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold ${i === 2 ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"}`}
                    >
                  ...
                  <div className="flex gap-3">
                    <button
                      type="button"
                      className="flex-1 py-2 rounded-lg border border-border hover:bg-muted font-medium text-sm transition-colors"
                    >
                      View Submissions
                    </button>
                    <button
                      type="button"
                      className="flex-1 py-2 rounded-lg bg-primary/5 text-primary hover:bg-primary/10 font-bold text-sm transition-colors"
                    >
                      Manage Project
                    </button>
                  </div>
          ...
          <div className="space-y-8">
            <section className="bg-card rounded-3xl p-6 border border-border shadow-sm">
              <h2 className="text-lg font-bold font-clash mb-6">
                  ...
                  <div key={i} className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Logistics Challenge • 98% Score
                      </p>
                    </div>
                    <button
                      type="button"
                      className="text-xs font-bold text-primary border border-primary px-3 py-1.5 rounded-full hover:bg-primary hover:text-white transition-colors"
                    >
                      View
                    </button>
                  </div>
            ...
            <section className="bg-primary/5 rounded-3xl p-6 border border-primary/10">
              <h2 className="text-lg font-bold font-clash mb-2">
                Hiring Pipeline
              </h2>
              <p className="text-sm text-muted-foreground mb-4 w-11/12">
                Identify potential interns from top performing students.
              </p>
              ...
              <button
                type="button"
                className="w-full mt-4 py-2.5 bg-primary text-white rounded-xl font-bold text-sm shadow-md hover:shadow-lg transition-all"
              >
                Go to Hiring Portal
              </button>
            </section>
