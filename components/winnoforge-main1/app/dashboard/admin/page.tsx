      ...
      <main className="flex-1 pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <div className="bg-white border border-border p-6 rounded-2xl shadow-sm">
            ...
            <span className="text-xs text-green-600 font-bold bg-green-100 px-2 py-0.5 rounded-full mt-2 inline-block">
              +3 this month
            </span>
          </div>
          <div className="bg-white border border-border p-6 rounded-2xl shadow-sm">
            ...
            <span className="text-xs text-blue-600 font-bold bg-blue-100 px-2 py-0.5 rounded-full mt-2 inline-block">
              12 funded
            </span>
          </div>
          <div className="bg-white border border-border p-6 rounded-2xl shadow-sm">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-card rounded-3xl p-6 border border-border shadow-sm min-h-[400px] flex flex-col">
              ...
              <div className="flex-1 bg-muted/20 rounded-2xl border border-dashed border-border flex items-center justify-center relative overflow-hidden group">
                ...
                <div className="text-center z-10">
                  ...
                  <p className="text-muted-foreground">
                    Interactive Geographical Map Placeholder
                  </p>
                  <p className="text-xs text-muted-foreground/60">
                    (Would show live activity across India)
                  </p>
                </div>
                {/* Mock Hotspots */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <section className="bg-card rounded-3xl p-6 border border-border shadow-sm">
                <h2 className="text-lg font-bold font-clash mb-4">
                  Pending Approvals
                </h2>
                <div className="space-y-4">
                  {[
                    {
                      type: "Institute",
                      name: "Tech University of Valley",
                      action: "Chapter Request",
                    },
                    {
                      type: "Industry",
                      name: "AutoCorp Global",
                      action: "Partner Account",
                    },
                    {
                      type: "Mentor",
                      name: "John Doe (Ex-Google)",
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.name} className="flex items-center gap-3">
                      <div className="font-bold text-muted-foreground text-sm w-4">
                        {i + 1}
                      </div>
          ...
          <div className="space-y-8">
            ...
            <section className="bg-card rounded-3xl p-6 border border-border shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="p-4 bg-muted/40 hover:bg-muted rounded-xl flex flex-col items-center justify-center gap-2 text-center transition-colors"
                >
            ...
            <section className="bg-gradient-to-br from-primary/10 to-blue-500/10 rounded-3xl p-6 border border-primary/20">
              <h2 className="text-lg font-bold font-clash mb-3 text-primary">
                System Refresh
              </h2>
              <p className="text-xs text-muted-foreground mb-4">
                Last data sync was 2 hours ago. Update to see real-time metrics.
              </p>
              <button
                type="button"
                className="w-full bg-primary text-white font-bold text-sm py-2 rounded-lg shadow-md hover:bg-primary/90 transition-colors"
              >
                Sync Data Now
              </button>
            </section>
