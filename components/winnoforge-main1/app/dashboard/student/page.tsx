              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/30 p-4 rounded-xl border border-border/50 hover:border-primary/30 transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Team formation phase ends in 2 days.
                  </p>
                  <button
                    type="button"
                    className="text-sm border border-primary text-primary px-3 py-1 rounded-full hover:bg-primary hover:text-white transition-colors"
                  >
                    Find Teammates
                  </button>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-muted/30 rounded-xl">
                  ...
                  <p className="text-sm text-foreground/80">
                    "Great progress on the MVP. Focus on the user onboarding
                    flow for the next sprint."
                  </p>
                </div>
              </div>
              <button
                type="button"
                className="w-full mt-4 py-2 text-sm text-primary font-medium hover:bg-primary/5 rounded-lg transition-colors"
              >
                Request Session
              </button>
            </section>
