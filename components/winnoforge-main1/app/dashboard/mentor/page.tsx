      ...
      <main className="flex-1 pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="bg-primary text-white px-5 py-2 rounded-full font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-2"
            >
            ...
            <section className="bg-card rounded-3xl p-6 border border-border shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[1, 2].map((i) => (
                  <div
                    key={i}
                    className="p-5 border border-border rounded-2xl hover:border-primary/50 transition-colors group"
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Project:{" "}
                            {i === 1 ? "Smart Logistics" : "EdTech App"}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-1.5 mb-4">
                      <div
                        ...
                        style={{ width: i === 1 ? "75%" : "40%" }}
                      ></div>
                    </div>
                    <div className="flex gap-2">
                      <button
                        type="button"
                        className="flex-1 text-xs font-bold py-2 rounded-lg bg-muted hover:bg-muted/80 transition-colors"
                      >
                        View Progress
                      </button>
                      <button
                        type="button"
                        className="flex-1 text-xs font-bold py-2 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors"
                      >
                        Give Feedback
                      </button>
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-muted/20 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-foreground/80 my-1">
                      Team Alpha submitted a new pitch deck for the logistics
                      problem.
                    </p>
                    <div className="flex gap-2 mt-2">
                      ...
                      <button
                        type="button"
                        className="text-xs bg-primary text-white px-3 py-1 rounded shadow-sm hover:bg-primary/90"
                      >
                        Approve
                      </button>
                    </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-muted/20 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-foreground/80 my-1">
                      Team Beta completed the "User Research" phase.
                    </p>
                    <div className="flex gap-2 mt-2">
                      <button
                        type="button"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-3xl p-6 border border-yellow-200 text-center relative overflow-hidden">
              ...
              <p className="text-sm text-yellow-800 mb-2">
                You are in the top 5% of mentors this month!
              </p>
              <p className="text-xs text-yellow-700 font-medium">
                15 Hours Contributed
              </p>
            </div>
          </div>
        </div>
